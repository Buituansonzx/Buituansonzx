...
<html lang="en">
    <head>
        ...
        <!-- Favicon-->
        <link rel="shortcut icon" type="image/x-icon" href="assets/bad.ico" />
        <!-- Bootstrap icons-->
        <link
    ...
    <body>
        ...
        <!-- Header-->
        <header class=" py-5">
           <img src="https://theme.hstatic.net/1000351433/1001044852/14/logo.png?v=86%22" alt="alt" width="100%" height="auto"/>
        </header>
        <!-- Section-->
        <section class="py-5" >
                    ...
                    <div class="col-md-3 mb-5">
                        ...
                        <ul class="list-group category_block" >
                            <c:forEach items="${listCategories}" var="C">
                                <li style="border: none; background-color:#f47916; font-weight: 600" class="list-group-item text-white ${tag == C.cid? "active":""}"><a href="category?categoryId=${C.cid}">${C.cname}</a></li>
                            </c:forEach>
                        </ul>
                    </div>
                    <div class="col-md-9">
                        <h1 class="text-lg-center">LIST PRODUCTS</h1>
                        <c:choose>
